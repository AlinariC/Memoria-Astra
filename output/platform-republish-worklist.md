...
Live dashboard snapshot: May 2026. Updated after the 2026-05-17 Amazon KDP final Bookshelf audit, 21:17 MST local package recheck, and user-reported KDP submission completion at 21:36 MST; `output/republishing-progress.md` and `output/kdp-upload-checkpoint.md` are the detailed live ledgers.
...
- Amazon KDP hardcover: only for 00 and 06, using `output/<slug>/amazon-kdp/print/hardcover/<slug>-hardcover-interior.pdf` and `output/<slug>/amazon-kdp/print/hardcover/<slug>-hardcover-cover.pdf`
...
Missing from KDP Bookshelf: none as of the 2026-05-17 21:11 MST audit.

KDP hardcover action: create/refresh hardcover only for 00 and 06 in the current pricing plan. Books 01-05, 07, and 08 remain paperback/Kindle only unless that plan changes.
...
Missing from Google Play Books catalog: none as of the 2026-05-17 Partner Center check recorded in `output/republishing-progress.md`.
...
Apple Books note: all 9 `.itmsp` packages were delivered through Transporter on 2026-05-17; store processing/review may continue after delivery.
